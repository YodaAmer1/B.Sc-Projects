...
public class ExamBankDHController extends Application implements Initializable {
	...
	private void getSubjectsList() {
		//Message message = new Message(MessageType.GetSubjectsListDH, ClientUI.chat.client.user.getId());
		Message message = new Message(MessageType.GetSubjectsListDH, null);
	...
	private void getCoursesList() {
		//Message message = new Message(MessageType.GetCoursesListDH, ClientUI.chat.client.user.getId());
	...
	public void start(Stage primaryStage) throws Exception {
		Parent root = FXMLLoader.load(getClass().getResource("/gui/TempExamBANK.fxml"));
